...
public class GoodsXQBean {
    ...
    public static class DatasBean {
        ...
        public static class SpecListBean {
            ...
            @SerializedName("")
            private String _$20; // FIXME check this code
